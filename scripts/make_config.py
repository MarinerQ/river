...
if __name__ == "__main__":
    ...
    config_dict['training_parameters']['batch_size_valid'] = 128
    ...
    config_dict['training_parameters']['epoches_update'] = 30
    ...
    #config_dict['model_parameters']['ipca_path'] = '../scripts/ipca_models/IPCA_BNSFD_10000to500_ExpUnwrap_fixtc_lowspin_200Mpc_ww.pickle'
    config_dict['model_parameters']['ipca_path'] = '../scripts/ipca_models/IPCA_BNSFD_50000to1024_ExpUnwrap_fixtc_lowspin_200Mpc.pickle'
